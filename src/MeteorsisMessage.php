...
class MeteorsisMessage extends Notification implements ShouldQueue
{
    use ForwardsCalls;
    use Queueable;
    use SMSMessageable {
    ...
    {
        $this->limit_per_request = config('Meteorsis.limit_per_request');
        $this->senderid = config('services.meteorsis.senderid');
    ...
    protected function recipient($recipient): MeteorsisMessage
    {
